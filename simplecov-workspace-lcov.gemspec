...
# -*- encoding: utf-8 -*-
# stub: simplecov-workspace-lcov 0.1.0 ruby lib

Gem::Specification.new do |s|
  s.name = "simplecov-workspace-lcov".freeze
  s.version = "0.1.0"

  s.required_rubygems_version = Gem::Requirement.new(">= 0".freeze) if s.respond_to? :required_rubygems_version=
  s.require_paths = ["lib".freeze]
  s.authors = ["mikian".freeze, "fortissimo1997".freeze]
  s.date = "2019-10-23"
  s.description = "Custom SimpleCov formatter to generate a lcov style coverage.".freeze
  s.email = ["mikko@mikian.com".freeze, "fortissimo1997@gmail.com".freeze]
  s.extra_rdoc_files = [
    "LICENSE.txt",
    "README.markdown"
  ]
  s.files = [
    ...
    "simplecov-workspace-lcov.gemspec",
  ...
  s.homepage = "http://github.com/mikian/simplecov-lcov".freeze
